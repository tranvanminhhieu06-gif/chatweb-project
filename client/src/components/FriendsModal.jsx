        ...
        <div style={{
            ...
            >
                <div style={{ padding: '20px', borderBottom: '1px solid #fbcfe8', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'linear-gradient(to right, #fff0f5, #ffe4e1)' }}>
                    <h3 style={{ margin: 0, color: '#be185d', fontSize: '18px' }}>🤝 Lời mời kết bạn</h3>
                ...
                <div style={{ padding: '30px 20px', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: 0, color: '#64748b', fontSize: '14px', lineHeight: '1.5' }}>
                        Hệ thống kết bạn và nhắn tin riêng tư 1-1 sẽ sớm ra mắt. Cùng đón chờ bản cập nhật tiếp theo nhé! 🌸
                    </p>
                </div>
